...
class Qr_generator:
    def __init__(self, root):
        ...
        self.root.title("Qr generator | Developed by Rohit Singh Bani")

        title = Label(self.root, text=" Qr Code Generator", font=("times new roman", 40), bg='Black', fg='white',
        ...
        emp_Frame = Frame(self.root, bd=2, relief=RIDGE, bg="black")
        emp_Frame.place(x=50, y=100, width=500, height=380)

        emp_title = Label(emp_Frame, text="Employee Details", font=("goudy old style", 20), bg='black',
                          fg='white').place(x=0, y=0, relwidth=1)

        lbl_emp_code = Label(emp_Frame, text="Employee Id:", font=("times new roman", 15, "bold"), bg='white').place(
            x=20, y=60)
        lbl_name = Label(emp_Frame, text="Employee Name:", font=("times new roman", 15, "bold"), bg='white').place(x=20,
                                                                                                                   y=100)
        lbl_department = Label(emp_Frame, text="Department:", font=("times new roman", 15, "bold"), bg='white').place(
            x=20, y=140)
        lbl_designation = Label(emp_Frame, text="Designation:", font=("times new roman", 15, "bold"), bg='white').place(
            x=20, y=180)
        ...
        btn_generate = Button(emp_Frame, text="QR Generate", command=self.generate,
                              font=("times new roman", 18, "bold"), bg="white", fg="black").place(x=90, y=250,
                                                                                                  width=180, height=30)
        btn_clear = Button(emp_Frame, text="Clear", command=self.clear, font=("times new roman", 18, "bold"),
                           bg="white", fg="black").place(x=282, y=250, width=120, height=30)

        self.msg = ''
        self.lbl_msg = Label(emp_Frame, text=self.msg, font=("times new roman", 20,), bg='Black', fg="green")
        self.lbl_msg.place(x=0, y=310, relwidth=1)

        qr_Frame = Frame(self.root, bd=2, relief=RIDGE, bg="black")
        qr_Frame.place(x=600, y=100, width=300, height=380)

        emp_title = Label(qr_Frame, text="Employee QR Code", font=("goudy old style", 20), bg='black',
                          fg='white').place(x=0, y=0, relwidth=1)

        self.qr_code = Label(qr_Frame, text="  Qr Code \nNot Available", font=("times new roman", 20), bg="black",
